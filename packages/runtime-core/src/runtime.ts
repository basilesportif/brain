...
function behaviorParityInstructions(workspacePath: string): string[] {
  ...
  return [
    ...
    "For every dispatch_subagent action include summary, model, and effort. Use model gpt-5.5; effort medium for mechanical scoped edits, high for normal research/inspection/account lookup, and xhigh for risky ambiguous debugging architecture multi-step deploy-sensitive work.",
